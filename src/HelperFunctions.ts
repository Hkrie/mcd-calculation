...
import {
    CalibrationFactors,
    IonCurrentsPerUniqAmu,
    Mixture,
    OptimizedMeasurementData,
    PartialPressures,
    ProportionObjectForUniq,
    Proportions,
    RawCalibrationMeasurementData,
...
export function getIonCurrentForAmu(measurementData: OptimizedMeasurementData, amu: number) {
